...
>
  <span
    style={{
      color: darkMode ? "#FF6347" : "#4682B4", // Bracket color: red for dark mode, steel blue for light mode
    }}
  >
    {"{"}
  </span>
  <span
    style={{
      color: darkMode ? "black" : "white", // Name color: light gray for dark mode, dark gray for light mode
    }}
  >
    Rakesh Yedlapalli
  </span>
  <span
    style={{
      color: darkMode ? "#FF6347" : "#4682B4", // Bracket color: same as opening bracket
    }}
  >
    {"}"}
  </span>
